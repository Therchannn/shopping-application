--Để sử dụng DB mới vui lòng mở lệnh này run 1 lần rồi cmt nó lại nhé !
...
VALUES
('U000', 'admin', '1', 'Zair0u', '09832134', 'Ho Chi Minh', 1),
('U001', 'user', '1', 'User', '09372329', 'Ho Chi Minh', 0),
...
VALUES
    ('O001', 'U001', 259000.00, 10000.00, 'TIEN_MAT', 'Pending'),
    ('O002', 'U001', 842000.00, 15000.00, 'CHUYEN_KHOAN', 'Pending'),
    ('O003', 'U001', 640000.00, 12000.00, 'TIEN_MAT', 'Confirmed'),
    ('O004', 'U001', 915000.00, 15000.00, 'CHUYEN_KHOAN', 'Confirmed'),
    ('O005', 'U001', 1278000.00, 20000.00, 'CHUYEN_KHOAN', 'Confirmed'),
    ('O006', 'U001', 1117000.00, 0.00, 'TIEN_MAT', 'Completed'),
    ('O007', 'U001', 708000.00, 10000.00, 'CHUYEN_KHOAN', 'Completed'),
    ('O008', 'U001', 459000.00, 10000.00, 'TIEN_MAT', 'Completed'),
    ('O009', 'U001', 988000.00, 0.00, 'CHUYEN_KHOAN', 'Cancelled'),
    ('O010', 'U001', 1256000.00, 15000.00, 'CHUYEN_KHOAN', 'Cancelled'),
    ('O011', 'U002', 498000.00, 10000.00, 'TIEN_MAT', 'Pending'),
    ('O012', 'U002', 779000.00, 15000.00, 'CHUYEN_KHOAN', 'Pending'),
    ('O013', 'U002', 1256000.00, 20000.00, 'CHUYEN_KHOAN', 'Confirmed'),
    ('O014', 'U002', 1348000.00, 15000.00, 'CHUYEN_KHOAN', 'Confirmed'),
    ('O015', 'U002', 745000.00, 10000.00, 'TIEN_MAT', 'Confirmed'),
    ('O016', 'U002', 948000.00, 12000.00, 'TIEN_MAT', 'Completed'),
    ('O017', 'U002', 1339000.00, 15000.00, 'CHUYEN_KHOAN', 'Completed'),
    ('O018', 'U002', 459000.00, 10000.00, 'TIEN_MAT', 'Completed'),
    ('O019', 'U002', 1117000.00, 0.00, 'CHUYEN_KHOAN', 'Cancelled'),
    ('O020', 'U002', 1289000.00, 15000.00, 'CHUYEN_KHOAN', 'Cancelled'),
    ('O021', 'U003', 259000.00, 10000.00, 'TIEN_MAT', 'Pending'),
    ('O022', 'U003', 915000.00, 15000.00, 'CHUYEN_KHOAN', 'Pending'),
    ('O023', 'U003', 1278000.00, 20000.00, 'CHUYEN_KHOAN', 'Confirmed'),
    ('O024', 'U003', 658000.00, 10000.00, 'TIEN_MAT', 'Confirmed'),
    ('O025', 'U003', 1456000.00, 20000.00, 'CHUYEN_KHOAN', 'Confirmed'),
    ('O026', 'U003', 1117000.00, 0.00, 'TIEN_MAT', 'Completed'),
    ('O027', 'U003', 879000.00, 12000.00, 'CHUYEN_KHOAN', 'Completed'),
    ('O028', 'U003', 589000.00, 10000.00, 'TIEN_MAT', 'Completed'),
    ('O029', 'U003', 1089000.00, 0.00, 'CHUYEN_KHOAN', 'Cancelled'),
    ('O030', 'U003', 1298000.00, 15000.00, 'CHUYEN_KHOAN', 'Cancelled'),
    ('O031', 'U004', 385000.00, 10000.00, 'TIEN_MAT', 'Pending'),
    ('O032', 'U004', 724000.00, 12000.00, 'CHUYEN_KHOAN', 'Pending'),
    ('O033', 'U004', 1589000.00, 15000.00, 'CHUYEN_KHOAN', 'Confirmed'),
    ('O034', 'U004', 967000.00, 10000.00, 'TIEN_MAT', 'Confirmed'),
    ('O035', 'U004', 1435000.00, 20000.00, 'CHUYEN_KHOAN', 'Completed'),
    ('O036', 'U004', 1112000.00, 15000.00, 'CHUYEN_KHOAN', 'Completed'),
    ('O037', 'U004', 880000.00, 0.00, 'TIEN_MAT', 'Cancelled'),
    ('O038', 'U004', 1223000.00, 10000.00, 'CHUYEN_KHOAN', 'Cancelled'),
    ('O039', 'U005', 498000.00, 10000.00, 'TIEN_MAT', 'Pending'),
    ('O040', 'U005', 865000.00, 12000.00, 'CHUYEN_KHOAN', 'Pending'),
    ('O041', 'U005', 1247000.00, 15000.00, 'CHUYEN_KHOAN', 'Confirmed'),
    ('O042', 'U005', 983000.00, 10000.00, 'TIEN_MAT', 'Confirmed'),
    ('O043', 'U005', 1558000.00, 20000.00, 'CHUYEN_KHOAN', 'Completed'),
    ('O044', 'U005', 1134000.00, 15000.00, 'CHUYEN_KHOAN', 'Completed'),
